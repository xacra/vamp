...
```vamp
   ...
   ({a:1,b:2} - #Keys)  .: [1,2,3]        :: removed keys .. result is: values
   ({a:1,b:2} - #Vals)  .: ["a","b"]      :: removed values .. result is: keys
   ({a:1,b:2} % #Flip)  .: {1:"a",2:"b"}  :: mod[ulus]ified the object with #Flip flag .. flipped the object inside-out .. good heavens
